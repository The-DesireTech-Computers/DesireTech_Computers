...
const {validationHardDrive,HardDrive} = require('../../../model/pcParts/HardDriveModel');


let validateHardDrive = (req,res,next)=>{
    ...
    req.body.gallery= req.files.gallery;
     ...
     let {error} = validationHardDrive(req.body);
...
let validateUpdatedHardDrive= async (req,res,next)=>{
...
module.exports.validationHardDrive = validateHardDrive;
module.exports.validationUpdatedHardDrive = validateUpdatedHardDrive;