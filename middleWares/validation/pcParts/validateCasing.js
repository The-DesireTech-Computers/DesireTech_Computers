...
const {validationCasing,Casing} = require('../../../model/pcParts/CasingModel');


let validateCasing = (req,res,next)=>{
    ...
    req.body.gallery= req.files.gallery;
     ...
     let {error} = validationCasing(req.body);
...
let validateUpdatedCasing= async (req,res,next)=>{
...
module.exports.validationCasing = validateCasing;
module.exports.validationUpdatedCasing = validateUpdatedCasing;