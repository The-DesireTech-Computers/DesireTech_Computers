...
const MouseDisplay = (props) => {
	let [id, setId] = useState();
	let [data, setData] = useState();

	let addToCartBtnHandler = () => {
		let cart = localStorage.getItem("mouse_cart");
		...
		if (cart) {
			...
			localStorage.setItem("mouse_cart", data._id);
		}
		console.log(cart);
	};
				...
				>
					...
					<tbody>
						...
						<tr>
							...
							<td>{data ? data.Details.trackingmethod : ""}</td>
						</tr>
						<tr>
							<td>Maximum DPI:</td>
							<td>{data ? data.Details.maximumdpi : ""}</td>
						</tr>
						<tr>
							<td>Button:</td>
							<td>{data ? data.Details.button : ""}</td>
						</tr>
						<tr>
							<td>Weight Adjustment:</td>
							<td>{data ? data.Details.weightadjustment : ""}</td>
						</tr>
						<tr>
							<td>Scrolling Capablity:</td>
							<td>{data ? data.Details.scrollingcapablity : ""}</td>
						</tr>
						<tr>
							<th>Features</th>
							<th></th>
