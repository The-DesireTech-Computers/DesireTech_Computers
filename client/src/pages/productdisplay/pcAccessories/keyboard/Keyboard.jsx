...
const Keyboards = (props) => {
	...
	let addToCartBtnHandler = (product_id) => {
		...
		if (cart) {
			...
			localStorage.setItem("keyboard_cart", product_id);
		}
		console.log(cart);
	};
	...
	useEffect(() => {
		if (companyFilter) {
			...
			} else if (companyFilter === "Microsoft") {
				setData1(
					data1.filter((e) => {
						return e.Model.brand === "Microsoft";
					})
				);
			}
		}
			...
			<div className="container mt-5">
				<div className="cbcontainer">
					<div className="hero-image">
						<img src="/images/others/keyboard.jpg" className="cbimage" />
						<div className="heroimg">
							<div className="hero-text-light">
								<h1 id="cbh1text">Keyboards</h1>
								<p id="cbptext">Here you can find Keyboards</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div className="row mt-5">
				...
				<div className="col-md-8 ">
					<div className="container-fluid mt-3">
						<h3 className="cbheading">Keyboards:</h3>
