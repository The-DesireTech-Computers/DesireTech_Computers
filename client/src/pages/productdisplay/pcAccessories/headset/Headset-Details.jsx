...
const HeadsetDisplay = (props) => {
	...
	let addToCartBtnHandler = () => {
		...
		if (cart) {
			...
			localStorage.setItem("headset_cart", data._id);
		}
		console.log(cart);
	};
				...
				>
					...
					<tbody>
						...
						<tr>
							...
							<td>{data ? data.connectivity.connectiontype : ""}</td>
						</tr>
						<tr>
							<td>Connector:</td>
						...
						<tr>
							<td>Cord Length:</td>
							<td>{data ? data.connectivity.cordLength : ""}</td>
						</tr>
						<tr>
							<th>Features</th>
							<th></th>
