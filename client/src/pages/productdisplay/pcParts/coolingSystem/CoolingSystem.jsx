...
import CoolingSystemCategory from "./CoolingSystemCategory";
...
const CoolingSystem = (props) => {
	...
	let addToCartBtnHandler = (product_id) => {
		...
		if (cart) {
			...
			localStorage.setItem("coolingSystem_cart", product_id);
		}
		console.log(cart);
	};
			...
			<div className="container mt-5">
				<div className="cbcontainer">
					<div className="hero-image">
						<img src="/images/others/cooling.jpg" className="cbimage" />
						<div className="heroimg">
							<div className="hero-text-light">
								<h1 id="cbh1text">Cooling System</h1>
								<p id="cbptext">Here you can find cooling for PCs</p>
							</div>
						</div>
					</div>
				</div>
