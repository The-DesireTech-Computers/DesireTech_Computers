...
let ManageMicrophone = (props) => {
	...
	let handelAddBtn = () => {
		props.history.push("/admin-panel/addmicrophone");
	};
		...
		tableData = data.map((element) => {
			return (
				<TableListings
					...
					apiPath="accessories/microphone"
					onDelete={getData}
				/>
			);
		});
...
export default ManageMicrophone;
