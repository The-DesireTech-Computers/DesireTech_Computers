...
const UpdateFan = (props) => {
	...
	let handelSubmitBtn = async () => {
		...
		if (data.title === "") {
			...
			alert(
				"Please enter data in all the given fields (Fan_Dim)"
			);
					...
					>
						<div className={classes.form2}>
							<div className={classes.row}>
								...
								<br />
								<label className={classes.label} htmlFor="Block_Compatability">
								Block_Compatability:
								</label>
								<br />
							...
							<div className={classes.row}>
								...
								<input
									...
									onChange={(e) => {
										setData({ ...data,Model:{...data.Model,Type: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									onChange={(e) => {
										setData({ ...data,Block:{...data.Block,Block_Compatability: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									onChange={(e) => {
										setData({ ...data,Block:{...data.Block,Block_Dim: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									onChange={(e) => {
										setData({ ...data,Block:{...data.Block,Block_Material: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									onChange={(e) => {
										setData({ ...data,Radiator:{...data.Radiator,Radiator_Dim: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									onChange={(e) => {
										setData({ ...data,Radiator:{...data.Radiator,Radiator_Material: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									onChange={(e) => {
										setData({ ...data,Fan:{...data.Fan,Fan_Size: e.target.value}  });
									}}
								/>
								<br />
							...
							<div className={classes.row}>
								<input
									...
									onChange={(e) => {
										setData({ ...data,Fan:{...data.Fan,Fan_Dim: e.target.value}  });
									}}
								/>
								<br />
								<input
								...
								<input
									...
									required
									onChange={(e) => {
										setData({ ...data,Fan:{...data.Fan,Bearing_Type: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									required
									onChange={(e) => {
										setData({ ...data,Fan:{...data.Fan,Fan_RPM: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									required
									onChange={(e) => {
										setData({ ...data,Fan:{...data.Fan,Fan_Air_Flow: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									required
									onChange={(e) => {
										setData({ ...data,Fan:{...data.Fan,Fan_Noise: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									required
									onChange={(e) => {
										setData({ ...data,Fan:{...data.Fan,Fan_Connector: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									required
									onChange={(e) => {
										setData({ ...data,Fan:{...data.Fan,color: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									required
									onChange={(e) => {
										setData({ ...data,Tube:{...data.Tube,Tube_Dim: e.target.value}  });
									}}
								/>
								<br />
								<input
									...
									required
									onChange={(e) => {
										setData({ ...data,Tube:{...data.Tube,Tube_Material: e.target.value}  });
									}}
								/>
								<br />
								<input
