...
const AddPreBuilt = (props) => {
	...
	let handelSubmitBtn = async () => {
		...
		if (data.title === "") {
			...
			alert(
				"Please enter data in all the given fields  (processorMainFeatures)"
			);
			...
			alert(
				"Please enter data in all the given fields  (FrontPanel_Front_USB)"
			);
		} else if (data.FrontPanel_FrontAudioPorts === "") {
			alert(
				"Please enter data in all the given fields  (FrontPanel_FrontAudioPorts)"
			);
		} else if (data.Memory_Speed === "") {
			alert("Please enter data in all the given fields  (Memory_Speed)");
			...
			data.BackPanel_RearAudioPorts === 0 ||
			data.BackPanel_RearAudioPorts === ""
		) {
			alert(
				"Please enter data in all the given fields (BackPanel_RearAudioPorts)"
			);
			...
			formData.append(
				"FrontPanel_FrontAudioPorts",
				data.FrontPanel_FrontAudioPorts
			);
			...
			<div>
				...
				<div className={classes.main1}>
					<div className={classes.inputform1}>
						<h1 className={classes.h11}>Add PreBuilt</h1>
						<form
						...
						>
							<div className={classes.form21}>
								<div className={classes.row1}>
									...
									<br />
									<label className={classes.label1} htmlFor="cachePerProcessor">
										Cache Per Processor:
									</label>
									<br />
									...
									<br />
									<label className={classes.label1} htmlFor="MotherBoard_Name">
										MotherBoard Name:
									</label>
									<br />
									<label
								...
								<div className={classes.row1}>
									...
									<br />
									<label className={classes.label1} htmlFor="L3_Cache_Per_CPU">
										L3 Cache Per CPU:
									</label>
									<br />
									<label className={classes.label1} htmlFor="CPU_MainFeatures">
										CPU Main Features:
									</label>
									<br />
									...
									<br />
									<label className={classes.label1} htmlFor="OpticalDrive_Type">
										OpticalDrive Type:
									</label>
									<br />
									...
									<br />
									<label className={classes.label1} htmlFor="BackPanel_SP_DIF">
										BackPanel SP DIF:
									</label>
									<br />
								...
								<div className={classes.row1}>
									...
									<input
										...
										onChange={(e) => {
											setData({
												...data,
												FrontPanel_Front_USB: e.target.value,
											});
										}}
									/>
									<br />
									<input
										...
										onChange={(e) => {
											setData({
												...data,
												FrontPanel_FrontAudioPorts: e.target.value,
											});
										}}
									/>
									<br />
									...
									<input
										...
										onChange={(e) => {
											...
											if (RearAudioPorts < 0) {
												...
												setData({
													...data,
													BackPanel_RearAudioPorts: e.target.value,
												});
											}
										}}
									/>
