...
import classes from "./UpdatePreBuilt.module.css";
...
//fetching singel element from back-end
	...
	let handelSubmitBtn = async ()=>{
		...
		formData.append('title', data.title);
			...
			formData.append('processorMainFeatures', data.information.processorMainFeatures);
			...
			formData.append('FrontPanel_FrontAudioPorts', data.FrontPanelPorts.FrontAudioPorts);
			formData.append('BackPanel_PS_2', data.BackPanelPorts.PS_2);
			formData.append('BackPanel_Rear_USB', data.BackPanelPorts.Rear_USB);
			formData.append('BackPanel_RearAudioPorts', data.BackPanelPorts.RearAudioPorts);
		...
		await axios.put('preBuiltDesktop/'+data._id , formData)
		.then(res=>{
		...
		<Navbar />
			<div className={classes.main}>
				<div className={classes.inputform}>
					<h1 className={classes.h1}>Update PreBuilt</h1>
						...
						<div className={classes.form2}>
							...
							<div className={classes.row}>
								...
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,Type:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,formFactor:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,usage:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,processor:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,processorMainFeatures:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,cachePerProcessor:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,memory:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,storage:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,graphics:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,powerSupply:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,case:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,coolingSystem:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,operatingSystem:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,information:{...data.information,windows:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,MotherBoard:{...data.MotherBoard,chipset:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,MotherBoard:{...data.MotherBoard,motherBoardName:e.target.value}});
									}}
								/>
								<br />
							...
							<div className={classes.row}>
								...
								<input
									...
									required
									onChange={e=>{
										setData({...data,CPU:{...data.CPU,L3_Cache_Per_CPU:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,CPU:{...data.CPU,CPU_MainFeatures:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,Graphics:{...data.Graphics,GPU_Type:e.target.value}});
									}}
								/>
								<br />
								<input
								...
								<input
									...
									required
									onChange={e=>{
										setData({...data,Graphics:{...data.Graphics,VR_Ready:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,Memory:{...data.Memory,capacity:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,Memory:{...data.Memory,speed:e.target.value}});
									}}
								/>
								<br />
								<input
								...
								<input
									...
									required
									onChange={e=>{
										setData({...data,Optical_Drive:{...data.Optical_Drive,Type:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,Communication:{...data.Communication,LAN_Speed:e.target.value}});
									}}
								/>
								<br />
								<input
								...
								<input
									...
									required
									onChange={e=>{
										setData({...data,Audio:{...data.Audio,WIFI_Generation:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,FrontPanelPorts:{...data.FrontPanelPorts,Front_USB:e.target.value}});
									}}
								/>
								<br />
										<input
									...
									required
									onChange={e=>{
										setData({...data,FrontPanelPorts:{...data.FrontPanelPorts,FrontAudioPorts:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,BackPanelPorts:{...data.BackPanelPorts,PS_2:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									required
									onChange={e=>{
										setData({...data,BackPanelPorts:{...data.BackPanelPorts,Rear_USB:e.target.value}});
									}}
								/>
								<br />
								<input
									...
									onChange={e=>{
										...
										if(RearAudioPorts<0){
											...
											setData({...data,BackPanelPorts:{...data.BackPanelPorts,RearAudioPorts:e.target.value}});
										}
								...
								<input
									...
									onChange={e=>{
										...
										if(Rj45<0){
											...
											setData({...data,BackPanelPorts:{...data.BackPanelPorts,Rj45:e.target.value}});
										}
								...
								<input
									...
									onChange={e=>{
										...
										if(SP_DIF<0){
											...
											setData({...data,BackPanelPorts:{...data.BackPanelPorts,SP_DIF:e.target.value}});
										}
								...
								<input
									...
									required
									onChange={e=>{
										setData({...data,BackPanelPorts:{...data.BackPanelPorts,videoPort:e.target.value}});
									}}
								/>
								<br />
								<label className={classes.customfile}>
